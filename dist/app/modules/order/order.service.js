...
const createSingleOrder = async (orderData) => {
    const productData = await product_model_1.ProductModel.findById({ _id: new mongoose_1.default.Types.ObjectId(orderData.productId) });
...
exports.OrderServices = {
    createSingleOrder, getAllOrders, getOrdersByEmail
};
